...
//  for 은 반복횟수를 아는경우 while 은 반복횟수를 모르는 경우		
...
//						if(!(k > 9)) {
		...
		// 문제 1 주사위 2개를 굴려서 나올수있는 모든조합 예 1,1 1,2
...
//				}
			    ...
			    // 문제 2 주사위 2개의 합별로 나올수있는 조합 2개의합이 2인경우 3인경우
			    // 예 합2 : 1,1
			    // 예 합3 : 1,2 2,1
			    // 예 합4 : 1,3 3,1 2,2
			    // 예 합5 : 1,4 4,1 2,3 3,2
			    // 예 합6 : 1,5 5,1 2,4 4,2 3,3
//			    for (int i = 1; i <= 6; i++) {
//			    	for (int j = 1; j<= 6; j++) {
